...
public class ErrorFactory {
    ...
    public static final String CODE_WALLET_CREATED = "30001";
    public static final String CODE_WALLET_CREATED_NOT_ACTIVATED = "30002";
    public static final String CODE_WALLET_BLOCKED = "30003";
    public static final String CODE_WALLET_TERMINATED = "30004";
    public static final String CODE_WALLET_NOT_FOUND = "30005";
    ...
    public static final String CODE_WALLET_ID_NOT_FOUND = "150004";
